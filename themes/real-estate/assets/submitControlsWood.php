<?php 	/**	 * Template Name: Submition Controls Wood */ 
...
<div class="formcontrol checkbox inline-checkbox-view" ng-if="control.type=='checkbox'">
  <label for="{{control.htmlName}}" class="checkbox-label">{{control.label}}</label>
  <input type="checkbox" ng-model="control.value" ng-checked="{{control.value}}" ng-click="getLebelTxtVal($event,control.htmlName)" class="{{control.htmlName}}" id="{{control.htmlName}}"> 
</div>
<!-- Image -->
...
?>
  ...
  <div class="commentprompt"><input type="checkbox" ng-model="control.withComment" ng-checked="true"> Display Image & Add Comment (If Any) <input type="checkbox" ng-model="control.notRequired"> NOT REQUIRED</div>
  <div ng-bind-html="control.data" class="printShow"></div>
  <div class="imgcomment" ng-show="true">
...
<div class="formcontrol comment" ng-if="control.type=='comment'">
  ...
  <div class="wysiwygpretend" ng-show="control.editMode">
    <textarea <?php /* ?>ui-tinymce="tinymceOptions"<?php */ ?> ng-model="control.data"></textarea>

...
! function(A) {
    ...
    52: function(A, t) {
        ...
        t.defaultOptions = {
            ...
            append: !1,
            actionButtons: [],
            controlOrder: ["text", "paragraph", "checkbox", "checkbox-group", "file", "textarea", "autocomplete", "button", "date" , "header", "hidden", "number", "radio-group", "select"],
            dataType: "json",
            disableFields: [],
            disabledAttrs: [],

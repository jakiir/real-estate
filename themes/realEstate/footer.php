...
?>
	...
	<?php /* ?><script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/vendor.js"></script>
	...
	<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/js/form-builder-script.js"></script><?php */ ?>
